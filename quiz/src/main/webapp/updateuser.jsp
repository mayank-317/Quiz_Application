...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update users set uname = ?,uemail =?,umobile= ? where id = ?");
            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <div alight="left">
                        ...
                        <input type="text" class="form-control" placeholder="name" value="<%= rs.getString("uname")%>" name="uname" id="name" required >
                     </div>
                         
                    <div alight="left">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-control" placeholder="email" name="uemail" value="<%= rs.getString("uemail")%>" id="email" required >
                     </div>
                     <div alight="left">
                        <label class="form-label">Mobile</label>
                        <input type="text" class="form-control" placeholder="mobile" name="umobile" id="mobile" value="<%= rs.getString("umobile")%>" required >
                     </div>
                    <% }  %>
                         </br>
                     <div alight="right">
                         <input type="submit" id="submit" value="submit" name="submit" class="btn btn-primary">
                         <input type="reset" id="reset" value="reset" name="reset" class="btn btn-gray">
                     </div>  
                         <div align="right">
                             <p><a href="manageuser.jsp	">Click Back</a></p>
                         </div>
                </form>
            </div>          
        </div>
