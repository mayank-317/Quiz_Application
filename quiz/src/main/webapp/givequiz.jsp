        ...
        <table class="table table-bordered text-center">
            <thead>
                <tr>
					...
					String query = "SELECT DISTINCT category_name FROM quizzes";
               ...
               %>
					...
					<tr>
						...
						<td><a href="quizname.jsp?category_name=<%=category_name%>"><input type="start" id="start" value="start" name="start" class="btn btn-primary btn-sm"></a></td>
					</tr>
					<%
					}
					%>
